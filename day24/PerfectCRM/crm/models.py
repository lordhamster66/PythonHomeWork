...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    class Meta:
        ...
        permissions = (
            ...
            ("can_download_identity_photo", "可以下载身份证照片"),
            ("can_access_contract_detail", "可以查看合同信息"),
            ("can_reject_contract", "可以驳回合同"),
            ...
            ("can_access_customer_followup", "可以访问kind_admin下注册的客户跟进记录"),
            ("can_access_customer_followup_change", "可以访问kind_admin下注册的客户跟进记录的修改页面"),
